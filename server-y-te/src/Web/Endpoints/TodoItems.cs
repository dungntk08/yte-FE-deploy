using YTe.Application.Common.Models;
using YTe.Application.TodoItems.Commands.CreateTodoItem;
using YTe.Application.TodoItems.Commands.DeleteTodoItem;
using YTe.Application.TodoItems.Commands.UpdateTodoItem;
using YTe.Application.TodoItems.Commands.UpdateTodoItemDetail;
using YTe.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace YTe.Web.Endpoints;
